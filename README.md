...
![HB Library Viewer homepage screenshot with navigation, current sales summary, and static demo metrics](docs/assets/screenshots/viewer-home-readme.png)

_README screenshot uses fixture-backed, documentation-safe demo values generated by `tools/scripts/capture_documentation_screenshots.py`._
