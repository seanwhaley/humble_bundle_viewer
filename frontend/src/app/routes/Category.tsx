/**
 * Category route for exploring a single product category.
 */
...
/**
 * Category view with charts and a subproduct table.
 */
export default function Category() {
  ...
  // Use Suborders as primary Data Source
    ...
    <div className="w-full flex flex-col space-y-4">
      <div>
        ...
        <p className="text-muted-foreground">
          Drill into downloads and key types within this category.
        </p>
      </div>
