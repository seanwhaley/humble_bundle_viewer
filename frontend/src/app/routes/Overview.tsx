    ...
    <div className="w-full flex flex-col space-y-6">
      ...
      <OverviewSection
        ...
        <div className="mb-4 flex flex-wrap gap-2 text-xs text-muted-foreground">
          <span className={surfaceChipClass}>
            Click the Downloads and Keys tiles to narrow the current scope
          </span>
        </div>
      ...
      <OverviewSection
        eyebrow="Deep dive"
        icon={Sparkles}
        title="Open the heavier analytics only when you need them"
        description="Keep the first screen focused on urgency, current sales, recent purchases, and the theme cloud. Open the deeper breakdowns below when you want category, platform, publisher, and trend analysis."
        action={
          <Button
            type="button"
            size="sm"
