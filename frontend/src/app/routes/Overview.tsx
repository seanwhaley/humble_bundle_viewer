  ...
  return (
    <div className="w-full flex flex-col space-y-6">
        ...
        <div>
          <div>
            ...
            <h3 className="mt-3 text-xl font-semibold text-white">
              Track live bundles and this month’s Choice against what you
              already own
            </h3>
            <p className="mt-2 max-w-3xl text-sm text-slate-400">
              Put the active buying view first: check today’s live bundles and
              the current Humble Choice month before you drop into the deeper
              ownership and library charts below.
            </p>
          </div>
          <p className="mt-3 text-xs text-slate-500">
            Use the sidebar’s{" "}
            <span className="font-medium text-slate-300">Current sales</span>{" "}
      ...
      <section className="rounded-2xl border border-slate-800 bg-slate-950/60 p-6 shadow-sm shadow-black/20">
        <div>
          <div>
            ...
            <p className="mt-2 max-w-3xl text-sm text-slate-400">
              Keep the first scan focused on the six numbers that explain what
              is in scope right now. Downloads and Keys can narrow the scope
              directly, while Purchases resets back to the full view when
              filters are active.
            </p>
          </div>
        </div>
      ...
      <div className="grid gap-4 xl:grid-cols-[1.5fr,1fr]">
          ...
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <p className="mt-2 text-sm text-slate-400">
                Review your newest captured purchases before drilling into
                charts and tables.
              </p>
            </div>
        ...
        <section className="rounded-2xl border border-slate-800 bg-slate-950/60 p-6 shadow-sm shadow-black/20">
          ...
          <p className="mt-2 text-sm text-slate-400">
            ...
            <span className="font-medium text-slate-300">tag cloud</span>: words
            from recent subproduct titles and descriptions grow larger and
            bolder as they appear more often, while filler words are filtered
            out.
          </p>
      ...
      <section className="rounded-2xl border border-slate-800 bg-slate-950/60 p-6 shadow-sm shadow-black/20">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-sm text-slate-400">
              Keep the main categorical splits together so category and platform
              answers can be compared at the same glance.
            </p>
          </div>
        </div>
      ...
      <section className="rounded-2xl border border-slate-800 bg-slate-950/60 p-6 shadow-sm shadow-black/20">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-sm text-slate-400">
              Keep the time grouping control with the charts it changes so trend
              reading stays self-explanatory.
            </p>
          </div>
      ...
      <section className="rounded-2xl border border-slate-800 bg-slate-950/60 p-6 shadow-sm shadow-black/20">
        ...
        <p className="mt-2 max-w-3xl text-sm text-slate-400">
          Keep secondary inventory breakdowns together so the page gets
          progressively more detailed as you scroll.
        </p>
