...
vi.mock("../../../../src/data/selectors", () => ({
  ...
  buildSubproductItems: vi.fn(() => [
    {
      id: "video-1",
      subproductName: "Video One",
      parentName: "Video Bundle",
      infoUrl: "https://example.test/video-1",
      authorSummary: "Creator One",
      publisher: "Publisher One",
      descriptionSnippet: "First video.",
    ...
    {
      id: "video-2",
      subproductName: "Video Two",
      parentName: "Video Bundle",
      infoUrl: "https://example.test/video-2",
      authorSummary: "Creator Two",
      publisher: "Publisher Two",
      descriptionSnippet: "Second video.",
      product: { created_at: "2026-03-02T00:00:00Z" },
      downloads: [
        {
          platform: "video",
          url: "https://example.test/video-2.zip",
          size_bytes: 2000,
          contentLabel: "ZIP",
        },
      ],
  ...
  isVideoPlatform: vi.fn((platform: string) => platform === "video"),
}));
...
vi.mock("../../../../src/components/FilterBar", () => ({
  __esModule: true,
  default: () => <div>Video FilterBar</div>,
}));
...
describe("Videos", () => {
  ...
  it("scopes bulk format choices to the currently selected rows", () => {
    ...
    fireEvent.click(screen.getByRole("button", { name: "Select first video row" }));
    ...
    expect(optionLabels).toEqual(expect.arrayContaining(["Select format", "MP4"]));
    expect(optionLabels).not.toContain("ZIP");
  });
});
