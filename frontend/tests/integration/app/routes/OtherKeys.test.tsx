...
import OtherKeys from "../../../../src/app/routes/OtherKeys";
import {
  PageHeaderProvider,
  usePageHeaderState,
...
describe("OtherKeys", () => {
  ...
  it("renders the Other Keys summary and allows key-type chart selection", () => {
    ...
    expect(
      screen.getByText("Keep Other Keys claims in one focused queue"),
    ).toBeInTheDocument();
    expect(
      screen.getByText("1 other-key row match the current library filters."),
    ).toBeInTheDocument();
