...
import Ebooks from "../../../../src/app/routes/Ebooks";
...
vi.mock("../../../../src/data/selectors", () => ({
  ...
  buildSuborders: vi.fn(() => [
    {
      id: "ebook-1",
      subproductName: "Reader One",
      authorSummary: "Author One",
      descriptionSnippet: "A reader-first title.",
      parentName: "Book Bundle",
      infoUrl: "https://example.test/ebook-1",
      viewerPagePath: "ebook-1.html",
      product: { created_at: "2026-03-01T00:00:00Z" },
      downloads: [
        {
          platform: "ebook",
          url: "https://example.test/ebook-1.epub",
          size_bytes: 1000,
          contentLabel: "EPUB",
        },
      ],
    ...
    {
      id: "ebook-2",
      subproductName: "Reader Two",
      authorSummary: "Author Two",
      descriptionSnippet: "A second title.",
      parentName: "Book Bundle",
      infoUrl: "https://example.test/ebook-2",
      viewerPagePath: "ebook-2.html",
      product: { created_at: "2026-03-02T00:00:00Z" },
      downloads: [
        {
          platform: "ebook",
          url: "https://example.test/ebook-2.pdf",
          size_bytes: 2000,
          contentLabel: "PDF",
        },
      ],
...
vi.mock("../../../../src/components/FilterBar", () => ({
  __esModule: true,
  default: () => <div>Ebook FilterBar</div>,
}));
...
describe("Ebooks", () => {
  ...
  it("reveals filters and managed sync only when the user opens them", () => {
    ...
    expect(screen.queryByText("Ebook FilterBar")).not.toBeInTheDocument();
    expect(screen.queryByText("Managed sync panel")).not.toBeInTheDocument();
    expect(screen.getByText("2 eBooks in the current view.")).toBeInTheDocument();
