...
import Downloads from "../../../../src/app/routes/Downloads";
...
describe("Downloads", () => {
  ...
  it("renders charts and triggers a direct download action", () => {
    ...
    expect(screen.getByText("Download inventory")).toBeInTheDocument();
